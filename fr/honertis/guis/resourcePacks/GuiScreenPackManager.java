package fr.honertis.guis.resourcePacks;
...
public class GuiScreenPackManager extends GuiScreen {
	...
	public GuiScreenPackManager(GuiScreen parentScreenIn)
    {
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(99, this.width - 80, 10, 70, 20, "Actualiser"));
