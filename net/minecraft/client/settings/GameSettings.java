...
public class GameSettings
{
    ...
    private static final String[] CLOUD_TYPES = new String[] {"options.off", "options.graphics.fast", "options.graphics.fancy"};
    ...
    public String getKeyBinding(GameSettings.Options settingOption)
    {
        ...
        else
        {
            ...
            {
                return s1 + getTranslation(CLOUD_TYPES, this.clouds);
            }
