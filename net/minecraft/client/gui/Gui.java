...
extends DrawUtils {
     ...
     */
    public static void drawModalRectWithCustomSizedTexture(double x, double y, double u, double v, double width, double height, float textureWidth, float textureHeight)
    {
